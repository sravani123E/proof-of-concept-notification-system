...
export default function App() {
  ...
  // Helper to fetch demo users from backend root log (not exposed). For POC, create a tiny endpoint.
  // Instead, we will allow manual input if we cannot auto-detect.
